    ...
    <>
      ...
      <main className="flex-1 bg-neutral-950 px-4 py-8 sm:px-6 lg:px-8 mx-auto w-full max-w-7xl">
        ...
        <div className="mb-10 rounded-xl bg-gradient-to-r from-neutral-900 to-neutral-800 p-8 border border-neutral-800">
          <span className="text-xs font-bold tracking-widest text-orange-500 uppercase font-mono">Performance Automotiva</span>
        ...
        <div className="mb-8">
          <h2 className="text-xs font-semibold uppercase tracking-wider text-neutral-400 font-mono mb-3">Categorias</h2>
        ...
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
          {filteredProducts.map((product) => {
            ...
            return (
              ...
              >
                {/* Imagem do Produto */}
                <div className="aspect-square w-full overflow-hidden rounded-md bg-neutral-950">
                  <img
                ...
                <div className="flex flex-1 flex-col pt-4">
                  <span className="text-[10px] font-bold tracking-wider text-orange-500 uppercase font-mono">{product.category}</span>
                  <h3 className="mt-1 text-sm font-bold text-neutral-100 group-hover:text-white line-clamp-1">
                    {product.name}
                  </h3>
